...
OWASP Juice Shop is probably the most modern and sophisticated (in)secure web application! It can be used in security
...
For a detailed introduction, full list of features and architecture overview please visit the official project pages:
